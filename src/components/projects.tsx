...
export default function Projects() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <motion.div className="relative flex flex-col gap-2">
        {projects.map((project) => (
          <motion.a
            key={project.id}
            href={project.href}
            target="_blank"
            className="relative z-10 -mx-4 flex cursor-pointer flex-col rounded-md p-4"
          ...
          >
            ...
            <h1 className="relative z-10">{project.title}</h1>
